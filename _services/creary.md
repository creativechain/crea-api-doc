...
#### creary.net endpoints

Creary.net offers a few endpoints for getting common data. User profile and post JSON data is very convenient and simple by appending .json
to your request. 

Getting a particular user profile JSON:

```
https://creary.net/@curie.json
```
   ...
   "user":{
      ...
      "json_metadata":{
         "profile":{
            ...
            "location":"Worldwide",
            "website":"http://curiecreaproject.io"
         }
      },
      "proxy":"",
      ...
      "reward_vesting_crea":"0.237 CREA",
...
```
https://creary.net/curation/@curie/the-daily-curie-12-13-feb-2017.json
```
...
```json
{
   "post":{
      ...
      "body":"<center>https://s29.postimg.org/dgtsfe7if/curie2.png</center>\n## Introduction\n[Curie](https://creary.net/creary/@donkeypong/announcing-project-curie-bringing-rewards-and-recognition-to-creary-s-undiscovered-and-emerging-authors)  is a commu ...",
      ...
      "total_pending_payout_value":"0.000 CBD"
   }
}
```
